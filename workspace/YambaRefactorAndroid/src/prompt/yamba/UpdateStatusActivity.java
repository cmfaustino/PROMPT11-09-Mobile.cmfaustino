...
public class UpdateStatusActivity extends BaseActivity {
	...
	private void submitTweet(String msgtxt){
		...
		boolean tc = tarefa.isCancelled(); // 1de2 linhas p/ suprimir warn. Eclipse
		tc = !tc; // 2de2 linhas para suprimir warnings no Eclipse

		// 2a versao de 3 - Service 
		//Intent msg = new Intent(this, UpdateStatusService.class);

		// 3a versao de 3 - IntentService 
